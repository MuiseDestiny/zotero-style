                ...
                var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__; !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! eve */ "./node_modules/eve-raphael/eve.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (eve) {
                    ...
                    var preventDefault = function () {
                        ...
                        getEventPosition = function (e) {
                            var scrollY = g.doc.documentElement.scrollTop || document.documentElement.scrollTop,
                                scrollX = g.doc.documentElement.scrollLeft || document.documentElement.scrollLeft;
                        ...
                        dragMove = function (e) {
                            var x = e.clientX,
                                y = e.clientY,
                                scrollY = g.doc.documentElement.scrollTop || document.documentElement.scrollTop,
                                scrollX = g.doc.documentElement.scrollLeft || document.documentElement.scrollLeft,
                                dragi,
                                j = drag.length;
                            while (j--) {
                   ...
                   \*/
                    ...
                    (function (doc, loaded, f) {
                        ...
                        function isLoaded() {
                            (/in/).test(doc.readyState) ? window.setTimeout(isLoaded, 9) : R.eve("raphael.DOMload");
                        }
                        isLoaded();
                ...
                var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__; !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! ./raphael.core */ "./dev/raphael.core.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (R) {
                    ...
                    R._engine.create = function () {
                        ...
                        if (container == 1) {
                            ...
                            R._document.documentElement.appendChild(cnvs);
                            isFloating = 1;
                        } else {
...
/***/ (function (module, exports, __webpack_require__) {
                ...
                var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__; !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! ./raphael.core */ "./dev/raphael.core.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (R) {
                    ...
                    R._engine.create = function () {
                        ...
                        if (container == 1) {
                            R._document.documentElement.appendChild(c);
                            cs.left = x + "px";
                            cs.top = y + "px";
